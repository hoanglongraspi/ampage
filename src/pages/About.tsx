...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-background/80 to-background relative overflow-hidden">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
                Our Mission
              </h2>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500/20 to-teal-500/20 rounded-3xl p-8 backdrop-blur-sm border border-blue-500/20">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-foreground font-semibold">Innovation-Driven</p>
                    <p className="text-muted-foreground text-sm">Advancing healthcare through technology</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <Card 
                key={index}
                className="group bg-card/60 backdrop-blur-sm border hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {specialties.map((specialty, index) => (
              <Card 
                key={index}
                className="group bg-card/60 backdrop-blur-sm border hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {team.map((member, index) => (
              <Card 
                key={index}
                className="group bg-card/60 backdrop-blur-sm border hover:border-blue-500/50 transition-all duration-500"
              >

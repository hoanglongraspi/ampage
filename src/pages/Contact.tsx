...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Address",
      details: "Baird Hall, University at Buffalo",
      description: "Buffalo, NY 14260, United States",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <Card 
                key={index}
                className="group bg-gray-900/60 backdrop-blur-sm border border-gray-700 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 text-center"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {departments.map((dept, index) => (
              <Card 
                key={index}
                className="group bg-gray-900/60 backdrop-blur-sm border border-gray-700 hover:border-teal-500/50 transition-all duration-500"
              >
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    <div className="bg-teal-500/20 w-12 h-12 rounded-xl flex items-center justify-center">
                      <dept.icon className="h-6 w-6 text-teal-400" />
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-white group-hover:text-teal-400 transition-colors">
                        {dept.title}
                      </h3>
                      <p className="text-teal-400 text-sm font-medium">{dept.email}</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <Card className="bg-gray-900/60 backdrop-blur-sm border border-gray-700">
                <CardContent className="p-8">
            ...
            <div>
              ...
              {/* Google Maps Embed */}
              <Card className="bg-gray-900/60 backdrop-blur-sm border border-gray-700 mb-8">
                <CardContent className="p-0">
                  <div className="relative h-80 rounded-lg overflow-hidden">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2925.738726583289!2d-78.78825492344654!3d42.95063997114789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d3726f8d3f0b5b%3A0x1d8f5c0e6b8e2a4c!2sBaird%20Hall%2C%20Buffalo%2C%20NY%2014260!5e0!3m2!1sen!2sus!4v1704067200000!5m2!1sen!2sus"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                      ...
                      title="Auspex Medix LLC Location - Baird Hall, University at Buffalo"
                    ></iframe>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900/60 backdrop-blur-sm border border-gray-700">
                <CardHeader>
                  <h3 className="text-2xl font-bold text-white mb-4">
                    <MapPin className="inline mr-3 h-6 w-6 text-blue-400" />
                    Our Location
                  </h3>
                </CardHeader>
                <CardContent className="pt-0">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-teal-400 mb-2">Directions</h4>
                      <p className="text-gray-300 text-sm">
                        Located on the North Campus of the University at Buffalo. 
                        Parking is available in nearby lots. Public transportation 
                        accessible via Metro Rail.
                      </p>
                    </div>

                    <div>
                      <h4 className="text-lg font-semibold text-green-400 mb-2">Office Hours</h4>
                      <p className="text-gray-300 text-sm">

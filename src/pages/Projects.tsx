  ...
  const projects = [
    {
      ...
      route: "/projects/speech-language-pathology",
      available: true
    },
    {
      icon: Activity,
      ...
      route: "/projects/physical-occupational-therapy",
      available: true
    },
    {
      icon: Volume2,
    ...
    },
    {
      ...
      route: "/projects/wound-healing-diabetic-care",
      available: true
    }
  ];
            ...
            <div className="flex flex-wrap justify-center gap-8 w-full">
              {projects.slice(0, 2).map((project, index) => (
                <div key={index} className="w-full sm:w-96 max-w-sm">
                  {project.available ? (
                    <Link to={project.route} className="block group hover:scale-105 transition-transform duration-300 cursor-pointer h-full">
